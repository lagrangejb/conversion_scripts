...
int main(int argc, char *argv[]) {
	...
	//printf("%s\n", argv[4]);
		...
		if(strcmp(argv[1], "ion") == 0 || strcmp(argv[1], "Ion") == 0 || strcmp(argv[1], "ION") == 0) {
			...
			q = atof(argv[3]);
			//printf("q = %lf", q);
			momentum = atof(argv[4]); // momentum per nucleon
			momentum *= z;
			if(strcmp(argv[5], "ev/c") == 0 || strcmp(argv[5], "eV/c") == 0 || strcmp(argv[5], "EV/c") == 0) {
				momentum *=1.;
			}
			else if(strcmp(argv[5], "mev/c") == 0 || strcmp(argv[5], "MeV/c") == 0 || strcmp(argv[5], "MEV/c") == 0 || strcmp(argv[5], "Mev/c") == 0) {
				momentum *=1.e6;
			}
			else if(strcmp(argv[5], "kev/c") == 0 || strcmp(argv[5], "KeV/c") == 0 || strcmp(argv[5], "KEV/c") == 0 || strcmp(argv[5], "Kev/c") == 0) {
				momentum *=1.e3;
			}
			else if(strcmp(argv[5], "gev/c") == 0 || strcmp(argv[5], "GeV/c") == 0 || strcmp(argv[5], "GEV/c") == 0 || strcmp(argv[5], "Gev/c") == 0) {
				momentum *=1.e9;
			}
			else if(strcmp(argv[5], "tev/c") == 0 || strcmp(argv[5], "TeV/c") == 0 || strcmp(argv[5], "TEV/c") == 0 || strcmp(argv[5], "Tev/c") == 0) {
				momentum *=1.e12;
			}
			else {
				COLOR("1;31");
			...
			if(momentum < 0.) errorstop("momentum < 0\n");
		}
			...
			if(strcmp(argv[3], "ev/c") == 0 || strcmp(argv[3], "eV/c") == 0 || strcmp(argv[3], "EV/c") == 0) {
				momentum *=1.;
			}
			else if(strcmp(argv[3], "mev/c") == 0 || strcmp(argv[3], "MeV/c") == 0 || strcmp(argv[3], "MEV/c") == 0 || strcmp(argv[3], "Mev/c") == 0) {
				momentum *=1.e6;
			}
			else if(strcmp(argv[3], "kev/c") == 0 || strcmp(argv[3], "KeV/c") == 0 || strcmp(argv[3], "KEV/c") == 0 || strcmp(argv[3], "Kev/c") == 0) {
				momentum *=1.e3;
			}
			else if(strcmp(argv[3], "gev/c") == 0 || strcmp(argv[3], "GeV/c") == 0 || strcmp(argv[3], "GEV/c") == 0 || strcmp(argv[3], "Gev/c") == 0) {
				momentum *=1.e9;
			}
			else if(strcmp(argv[3], "tev/c") == 0 || strcmp(argv[3], "TeV/c") == 0 || strcmp(argv[3], "TEV/c") == 0 || strcmp(argv[3], "Tev/c/") == 0) {
				momentum *=1.e12;
			}
			else {
				COLOR("1;31");
